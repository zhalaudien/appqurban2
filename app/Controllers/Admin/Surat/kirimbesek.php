                        ...
                        <table class="table table-hover align-middle mb-0" id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                <?php if (!empty($realisasi)): ?>
                                    <?php foreach ($realisasi as $hari => $items): ?>
                                        <tr class="table-light fw-bold text-start">
                                            <td colspan="14" class="ps-3 bg-secondary-subtle">
                                                <i class="bi bi-calendar-check me-2 text-primary"></i> JADWAL PENGIRIMAN: <span class="text-primary"><?= esc($hari) ?></span>
                                            </td>
                                        </tr>
